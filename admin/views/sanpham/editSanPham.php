...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-11">
                    <h1>Sửa Thông Tin Sản Phẩm : <?= $sanPham['ten_san_pham']?> <i class="fas fa-paw"></i></h1>
                </div>
...
html = '<tr id="faqs-row' + faqs_row + '">';
    html += '<td><img src="https://photo.znews.vn/w860/Uploaded/mfnuy/2024_05_13/sssss.jpg" style = "width:50px; height: 50px" alt=""></td>';
